...
from train_model import test_model as run_test_model
...
class TestModelTraining:
    ...
    def test_train_random_forest_model(self):
        ...
        model, _, _ = train_model(prompts, labels, model_type="random_forest", test_size=0.2)
    ...
    def test_invalid_model_type_raises(self):
        ...
        prompts = ["benign prompt " + str(i) for i in range(10)] + [
            "malicious prompt " + str(i) for i in range(10)
        ]
        labels = [0] * 10 + [1] * 10
