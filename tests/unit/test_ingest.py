...
class TestHeuristicDetection:
    ...
    def test_detects_prompt_injection(self):
        ...
        for prompt in malicious_prompts:
            blocked, risk_score, verdict, _threat_type = quick_heuristic_check(prompt)
    ...
    def test_detects_jailbreak_attempts(self):
        ...
        for prompt in jailbreak_prompts:
            blocked, risk_score, _verdict, _threat_type = quick_heuristic_check(prompt)
            assert blocked is True, f"Should block: {prompt}"
    ...
    def test_flags_data_extraction(self):
        ...
        for prompt in extraction_prompts:
            _blocked, risk_score, verdict, _threat_type = quick_heuristic_check(prompt)
